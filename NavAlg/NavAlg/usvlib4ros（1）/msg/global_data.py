...
class GlobalData:
    ...
    def updateThrottleRudderOutput(self,adviseSpeed, adviseRotate, advisedHeading,nextPointIndex,shipToNextWPDistance):
        self.navigation_output_data.advise_throttle = adviseSpeed
        self.navigation_output_data.advise_rudder = adviseRotate
        self.navigation_output_data.advise_heading = advisedHeading
        self.navigation_output_data.point_index = nextPointIndex
    ...
    def updateAlgorithmOutput(self,e, step, score,loss,max_e,status):
        self.navigation_output_data.e = e
        self.navigation_output_data.step = step
        self.navigation_output_data.score = score
        self.navigation_output_data.loss = loss
        self.navigation_output_data.max_e = max_e
        self.navigation_output_data.status = status
        self.navigation_output_data.time = time.time()
        pass
